...
const Banner = () => {
  ...
  <div className="relative w-full flex flex-col items-center lg:w-full lg:h-[200px]">
    ...
    <div   data-aos="fade-up"
      data-aos-duration="1000" className="relative w-full max-w-[600px] lg:p-[80px] md:max-w-[754px] lg:min-h-[444px] lg:max-w-[1012px] md:min-h-[470px] min-h-[410px] flex flex-col space-y-[24px] px-[24px] md:px-[20px] md:py-[80px] py-[40px] bg-neutral-800/50 rounded-[16px]">
      {/* Gradient Border */}
      <div 
